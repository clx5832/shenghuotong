...
import com.example.shenghuotong.huatu.MainActivity_huatu;
...
public class Four extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);
                ...
                ImageView nv9 = getActivity().findViewById(R.id.nv9);

                nv9.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent=new Intent(getActivity(), MainActivity_huatu.class);
